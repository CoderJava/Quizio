package com.ysn.quizio.question3;
...
public class Question3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        circularCountdown = findViewById(R.id.circular_count_down_activity_question3);
        textViewLabelPertanyaan = findViewById(R.id.text_view_label_pertanyaan_activity_question3);
        textViewPertanyaan = findViewById(R.id.text_view_pertanyaan_activity_question3);
        textViewJawaban1 = findViewById(R.id.text_view_jawaban_1_activity_question3);
        textViewJawaban2 = findViewById(R.id.text_view_jawaban_2_activity_question3);
        textViewJawaban3 = findViewById(R.id.text_view_jawaban_3_activity_question3);
        textViewJawaban4 = findViewById(R.id.text_view_jawaban_4_activity_question3);

        // Set pertanyaan-nya
        textViewLabelPertanyaan.setText("Pertanyaan 3/3");
        textViewPertanyaan.setText(
                "Aplikasi Java berjalan diatas sebuah virtual machine. Virtual machine " +
                        "tersebutlah yang membuat Java bisa berjalan secara multiplatform." +
                        "Apakah nama dari virtual machine tersebut?");

        // Set jawaban-nya
        textViewJawaban1.setText("DVM (Dalvik Virtual Machine)");
        textViewJawaban2.setText("VirtualBox");
        textViewJawaban3.setText("JVM (Java Virtual Machine)");
        textViewJawaban4.setText("V8 JavaScript");
        ...
        circularCountdown.create(pastTime, 10, CircularCountdown.TYPE_SECOND)
                .listener(new CircularListener() {
                    ...
                    public void onFinish(boolean b, int i) {
                        ...
                        sharedPreferences.edit().putInt("nomor_soal_sekarang", 4).apply();
                        int totalBenar = sharedPreferences.getInt("total_benar", 0);
                        int totalSalah = sharedPreferences.getInt("total_salah", 0);
                        if (pilihanJawaban == -1) {
                            totalSalah += 1;
                            new FancyAlertDialog.Builder(Question3Activity.this)
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.text_view_jawaban_1_activity_question3:
                pilihanJawaban = 1;
                ...
                textViewJawaban4.setBackground(
                        ContextCompat.getDrawable(this, R.drawable.bg_text_view_answer));
                break;
            case R.id.text_view_jawaban_2_activity_question3:
                pilihanJawaban = 2;
                textViewJawaban1.setBackground(
                        ContextCompat.getDrawable(this, R.drawable.bg_text_view_answer));
                textViewJawaban2.setBackground(
                ...
                textViewJawaban4.setBackground(
                        ContextCompat.getDrawable(this, R.drawable.bg_text_view_answer));
                break;
            case R.id.text_view_jawaban_3_activity_question3:
                pilihanJawaban = 3;
                textViewJawaban1.setBackground(
                        ContextCompat.getDrawable(this, R.drawable.bg_text_view_answer));
                textViewJawaban2.setBackground(
                ...
                textViewJawaban4.setBackground(
                        ContextCompat.getDrawable(this, R.drawable.bg_text_view_answer));
                break;
            case R.id.text_view_jawaban_4_activity_question3:
                pilihanJawaban = 4;
                textViewJawaban1.setBackground(
                        ContextCompat.getDrawable(this, R.drawable.bg_text_view_answer));
                textViewJawaban2.setBackground(
